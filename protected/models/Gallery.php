...
class Gallery extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('gallery_main_id, title', 'required'),
			array('gallery_main_id', 'numerical', 'integerOnly'=>true),
			...
			array('id, gallery_main_id, title, image', 'safe', 'on'=>'search'),
		);
	}
